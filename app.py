...
candidatos = [
    ...
    },
    {
        ...
        "propuesta": "Reforma integral a la justicia, incentivos y creditos para el sector agricola nacional, doctrina de seguridad democratica y oposicion firme a las reformas estatales de izquierda."
    },
    {
...
# ==========================================
# 7. COMPONENTE HTML EXTERNO (MANEJO DE ENCODING SEGURO)
# ==========================================
st.write("---")
...
if os.path.exists("index.html"):
    try:
        # Intentamos leer index.html con utf-8 estricto
        with open("index.html", "r", encoding="utf-8") as f:
            html_source = f.read()
    except UnicodeDecodeError:
        # Si falla, usamos cp1252/latin-1 para evitar que la app tire error en el servidor
        with open("index.html", "r", encoding="cp1252") as f:
            html_source = f.read()
