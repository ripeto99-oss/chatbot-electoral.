...
# Incluimos los parámetros de corrección "css_custom" para calibrar cada rostro individualmente
candidatos = [
    {
        "col": col1,
        ...
        "propuesta": "Enfoque de seguridad estricta, libre mercado, reducción drástica del gasto público, privatizaciones y defense de las instituciones tradicionales."
    },
    {
        "col": col2,
        "nombre": "Iván Cepeda",
...
for cand in candidatos:
    with cand["col"]:
        if os.path.exists(cand["foto"]):
            ...
            # Se aplica el ajuste fino CSS personalizado para centrar las caras
            img_html = f'<img src="data:image/jpeg;base64,{encoded_string}" style="{cand["css_custom"]}">'
        else:
